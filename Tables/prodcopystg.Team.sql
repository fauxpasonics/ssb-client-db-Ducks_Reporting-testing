...
[copyloaddate] [datetime] NULL CONSTRAINT [DF__Team__copyloadda__5FB337D6] DEFAULT (getdate())
)
GO
ALTER TABLE [prodcopystg].[Team] ADD CONSTRAINT [PK__Team__5ED65F32060B65BE] PRIMARY KEY CLUSTERED  ([teamid])
GO
